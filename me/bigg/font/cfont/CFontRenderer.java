...
public class CFontRenderer extends CFont {
   ...
   public float drawStringWithShadow(String text, double x, double y, int color) {
      float shadowWidth = this.drawString(text, x + 0.8, y + 0.8, color, true);
   ...
   public float drawCenteredString(String text, float x, float y, int color) {
      return this.drawString(text, x - (float)(this.getStringWidth(text) / 2) - 1.0F, y, color);
   }

   public float drawCenteredStringWithShadow(String text, float x, float y, int color) {
      return this.drawStringWithShadow(text, (double)(x - (float)(this.getStringWidth(text) / 2) - 1.0F), (double)y, color);
   }

   public float drawCenteredStringWithShadow(String text, double x, double y, int color) {
      return this.drawStringWithShadow(text, x - (double)(this.getStringWidth(text) / 2) - 1.0, y, color);
   }
   ...
   public List wrapWords(String text, double width) {
      ...
      if ((double)this.getStringWidth(text) > width) {
         ...
         for(int n2 = 0; n2 < n; ++n2) {
            ...
            if ((double)this.getStringWidth(String.valueOf(currentWord) + s + " ") < width) {
               currentWord = String.valueOf(currentWord) + s + " ";
            } else {
               finalWords.add(currentWord);
               currentWord = String.valueOf(167 + lastColorCode) + s + " ";
            }
         }
