...
public class GuiAltLogin extends GuiScreen {
   ...
   public void drawScreen(int x, int y, float z) {
      ...
      this.mc.fontRendererObj.drawString("Alt Login", this.width / 2 - this.mc.fontRendererObj.getStringWidth("Alt Login") / 2, 20, -1);
      this.mc.fontRendererObj.drawString(this.thread == null ? "§eWaiting..." : this.thread.getStatus(), this.width / 2 - this.mc.fontRendererObj.getStringWidth(this.thread == null ? "§eWaiting..." : this.thread.getStatus()) / 2, 29, -1);
