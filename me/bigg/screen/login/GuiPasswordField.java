...
public final class GuiPasswordField extends Gui {
   ...
   private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
      ...
      worldrenderer.pos((double)p_146188_1_, (double)p_146188_4_, 0.0);
      worldrenderer.pos((double)p_146188_3_, (double)p_146188_4_, 0.0);
      worldrenderer.pos((double)p_146188_3_, (double)p_146188_2_, 0.0);
      worldrenderer.pos((double)p_146188_1_, (double)p_146188_2_, 0.0);
      tessellator.draw();
      GL11.glDisable(3058);
      GL11.glEnable(3553);
   }
   ...
   public int func_146197_a(int p_146197_1_, int p_146197_2_, boolean p_146197_3_) {
      ...
      for(int var7 = 0; var7 < var6; ++var7) {
         if (!var5) {
            ...
            while(true) {
               --var4;
               if (var4 <= 0 || this.field_146216_j.charAt(var4 - 1) == ' ') {
                  break;
               }
            }
         }
